{{--
    Brain Floating Widget

    Drop this anywhere in your admin layout (e.g. the bottom of your master template):

        @include('brain::widget')

    The widget injects its own styles and JS — no build step required.
    It respects your application's CSRF token automatically.
--}}
...
<style>
    ...
    .bw-msg.assistant .bw-bubble {
        background: #0f1117;
        color: #e2e8f0;
        border: 1px solid #2d3148;
        border-bottom-left-radius: 3px;
    }
    .bw-msg.error .bw-bubble {
        background: #2d1515;
        color: #f87171;
    ...
    .bw-msg.assistant .bw-bubble h1,
    .bw-msg.assistant .bw-bubble h2,
    .bw-msg.assistant .bw-bubble h3 {
        margin: 0.6em 0 0.2em;
        font-size: 0.95em;
        font-weight: 700;
        color: #f1f5f9;
    }
    .bw-msg.assistant .bw-bubble h1:first-child,
    .bw-msg.assistant .bw-bubble h2:first-child,
    .bw-msg.assistant .bw-bubble h3:first-child { margin-top: 0; }
    .bw-msg.assistant .bw-bubble ul,
    .bw-msg.assistant .bw-bubble ol { margin: 0.2em 0 0.5em; padding-left: 1.3em; }
    ...
    .bw-msg.assistant .bw-bubble code {
        background: #1a1d27;
        border: 1px solid #2d3148;
        border-radius: 3px;
        padding: 1px 4px;
    ...
    .bw-msg.assistant .bw-bubble pre {
        background: #1a1d27;
        border: 1px solid #2d3148;
        border-radius: 5px;
        padding: 8px 10px;
    ...
    .bw-msg.assistant .bw-bubble blockquote {
    ...
    .bw-dots span {
        ...
        border-radius: 50%;
        margin: 0 1px;
        animation: bw-blink 1.2s infinite;
    }
    ...
    window.bwSend = function () {
        ...
        .then(function (data) {
            ...
            if (data.error) {
                ...
                var meta = [data.intent, data.driver, data.elapsed + 'ms']
                    .filter(Boolean).join('  |  ');
